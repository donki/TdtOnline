...
public static class Loc
{
    private static readonly Dictionary<string, string> English = new()
    {
        ...
        ["PrivacyText"] = "TDT Online downloads the channel lists from {0} (Apache 2.0) and {1}, both maintained by the community with the streams each broadcaster publishes openly, and just opens them: it hosts and relays nothing. Only open, unencrypted streams are listed. Favorites and the last channel stay on the device. There are no accounts, no ads and no analytics.",
    ...
    private static readonly Dictionary<string, string> Spanish = new()
    {
        ...
        ["PrivacyText"] = "TDT Online descarga las listas de canales de {0} (Apache 2.0) y de {1}, mantenidas por la comunidad con las emisiones que cada cadena publica en abierto, y se limita a abrirlas: no aloja ni reemite nada. Solo se listan emisiones abiertas y sin cifrar. Los favoritos y el último canal se quedan en el dispositivo. No hay cuentas, ni anuncios, ni analítica.",
